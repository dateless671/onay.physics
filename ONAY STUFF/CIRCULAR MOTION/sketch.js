...
function setup() {
    ...
    for (let i = 0; i < numPlanets; i++) {
        let mass = random(7, 15)
        let radius = random(sun.d, min(windowWidth / 2.5, windowHeight / 2.5))
...
function Body(_mass, _pos, _vel) {
    ...
    this.move = function() {
        ...
        if (this.path.length > 75) this.path.splice(0, 1)
    }
